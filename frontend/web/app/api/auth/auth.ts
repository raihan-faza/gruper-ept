...
<body>
  <div class="wrapper">
    <div class="container">
      <div class="logo">Gruper</div>
      <h1>Verify Your Email Address</h1>
      <p>Thank you for signing up for Gruper. Please verify your email address by clicking the button below:</p>
      ...
      <div class="thanks">
        ...
        <br><br>
        Warm regards,<br>
        <strong>The Gruper Team</strong>
      </div>
    </div>
    <div class="footer">
      &copy; ${new Date().getFullYear()} Gruper. All rights reserved.
    </div>
  </div>
</body>
</html>
    ...
    sendVerificationEmail: async ({ user, url }) => {
      try {
        const { data: resendData, error } = await resend.emails.send({
          from: "Gruper <onboarding@gruper.web.id>",
          to: user.email,
          subject: "Verify Your Gruper Account",
